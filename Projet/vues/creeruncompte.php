    ...
    <div class="container-fluid h-custom">
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <form method="post" action="index.php?action=seEnregistrer">
            <!-- Name input -->
                <div class="form-outline mb-4">
                  <input type="text" name="loginRegister" id="form3Example3" class="form-control form-control-lg"
                    placeholder= "Entrez votre login" required/>
                </div>

                <!-- Password input -->
                <div class="form-outline mb-3">
                  <input type="password" name="passwordRegister" id="form3Example4" class="form-control form-control-lg"
                    placeholder="Entrez votre mot de passe" required/>
                </div>

                <!-- Password confirmation input -->
                <div class="form-outline mb-3">
                  <input type="password" name="passwordRegisterRetype" id="form3Example4" class="form-control form-control-lg"
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  ...
                  <p class="small fw-bold mt-2 pt-1 mb-0">Vous avez déjà un compte ? <a href="index.php?action=connection"
