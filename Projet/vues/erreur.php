        ...
        <nav class="navbar navbar-expand-lg ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    {?>
                        <li class="nav-item">
                            <a class="nav-link active" href="index.php?action=connection">Accueil <span class="sr-only">(current)</span></a>
                        </li>
                        <?php
                    }
                    else{ ?>
    ...
    <div class="text">
        <div class="text-inner">
            ...
            <div id="home" class="button">
                ...
                if (! isset($_SESSION['login']))
                {?>
                        <a class="nav-link active" href="index.php?action=connection">Revenir à l'accueil <span class="sr-only">(current)</span></a>

                    <?php
                }
                else{ ?>
                    <a class="nav-link active" href="index.php?action=home">Revenir à l'accueil <span class="sr-only">(current)</span></a>
                    <?php
                }
                ?>
            </div>
